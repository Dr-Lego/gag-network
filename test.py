...
def approach1():
    return [i for i in range(10000) if i%8 == 0]

def approach2():
    return next(iter([i for i in range(10000) if i%8 == 0]))

print(timeit.timeit(approach1, number=1000))  # 1.43 seconds
print(timeit.timeit(approach2, number=1000))  # 1.35 seconds